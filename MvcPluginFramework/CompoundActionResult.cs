...
namespace Kusog.Mvc
{
    public class CompoundActionResult : ActionResult
    {
        ...
        internal void AddResultToBegining(ActionResult result)
        {
            m_results.Insert(0, result);
        }
        internal void WrapResults(ActionResult beginResult, ActionResult endResult)
        {
            AddResultToBegining(beginResult);
            AddResult(endResult);
        }
        internal void WrapResults(string beginResult, string endResult)
        {
