...
namespace PluginDemo
{
    ...
    {
        public enum DemoAppResourceTypes { HeaderIncPre, HeaderIncPost, FooterInc, Widget, MenuItem };
        ...
        protected virtual bool ShouldIncludeResource(DemoAppResourceTypes type, IMvcPlugin plugin, object resource)
        {
            ...
            if (plugin != null)
            {
                if (should && plugin is DemoAppPlugin)
        ...
        public static PluginDemoApplication SetupApplication(object bundles)
        {
            PluginDemoApplication me = new PluginDemoApplication(bundles);
            return me;
        }

        protected PluginDemoApplication(object bundles)
            :base(bundles)
        {
        }
    }
